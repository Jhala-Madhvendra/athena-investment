...
function BusinessPerformanceRow({ label, value, direction, invert = false, insightText }) {
  return (
    <div className="flex flex-col gap-1.5 border-b border-border py-4 last:border-0 sm:flex-row sm:items-baseline sm:gap-6">
      <span className="text-sm font-semibold text-ink-secondary sm:w-40 sm:shrink-0">{label}</span>
